/**
 * Запросы к пользовательской таблице locale
 */
'use strict';
...
router.get('/:data_id',
  ...
  function* () {
    ...
    this.body = yield localeTable.find(this.params.data_id, options);
  });
...
router.get('/',
  ...
  function* () {
    ...
    this.body = yield localeTable.findAll(filter, options);
  });
